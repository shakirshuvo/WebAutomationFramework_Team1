...
//    Cell cell = null;
    ...
    public String[][] fileReaderArrayStringArraysXSSF(String path, int sheetIndex) throws IOException {
        String[][] data = {};
        File file = new File(path);
        FileInputStream fis = new FileInputStream(file);
        xssfWorkbook = new XSSFWorkbook(fis);
    ...
    public String[] fileReaderStringXSSF(String path, int sheetIndex) throws IOException {
        String[] data = {};
        File file = new File(path);
        FileInputStream fis = new FileInputStream(file);
