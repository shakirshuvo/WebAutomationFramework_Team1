...
@Test
    ...
    @Test
    public void testNewAmazonDevices(){
        homePage.newAmazonDevicesCheck();
        homePage.validateNewAmazonDevices();
    }
    @Test
    ...
    public void testSellOnAmazon(){
        homePage.sellAppsOnAmazonCheck();
        homePage.validateAppsSellOnAmazon();
    }
    @Test
